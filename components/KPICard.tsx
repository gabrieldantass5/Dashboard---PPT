  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-slate-100/50 hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_10px_10px_-5px_rgba(0,0,0,0.04)] hover:-translate-y-1 transition-all duration-300 flex flex-col h-full group">
      <div className="flex justify-between items-start mb-4">
        <div className="p-3 bg-gradient-to-br from-ssp-50 to-white rounded-xl shadow-sm border border-ssp-100 group-hover:scale-110 transition-transform duration-300">
      ...
      <div className="text-3xl font-black text-slate-800 mb-2 tracking-tight group-hover:text-ssp-700 transition-colors">{value}</div>
      ...
      {observation && (
        <div className="mt-auto pt-4 border-t border-slate-50">
          <div className="bg-slate-50/80 px-3 py-2 rounded-lg border border-slate-100">
            <p className="text-[10px] text-ssp-800 font-bold flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-ssp-500 shadow-[0_0_8px_rgba(59,130,246,0.6)]"></span>
              {observation}
            </p>
          </div>
        </div>
